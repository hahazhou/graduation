...
class MultiLabelTextProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        data_df = pd.read_csv(os.path.join(data_dir, 'short_test.csv'), delimiter='_!_', encoding='utf-8')
        return self._create_examples(data_df, "test")

    def get_labels(self):
        """See base class."""
        return [100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116]
...
##    count = count + 1
##    question = input("> ")
##    predict_example = InputExample(count, question, 0)
